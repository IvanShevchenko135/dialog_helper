...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_path', type=str, help='Path to tsv file', default='common_voice/train.tsv')
    ...
    parser.add_argument('--limit', type=int, help='Limit for processing files', default=None)  # for testing script
